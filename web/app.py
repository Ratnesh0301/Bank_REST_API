...
def verifyCredentials(username,password):
    ...
    if not correct_pw:
        return generateReturnDictionary(302,"Invalid Psssword"), True
...
class Add(Resource):
    def post(self):
        ...
        if money<= 0 :
            return jsonify(generateReturnDictionary(304,"The money amount entered must be greater thean zero"))
